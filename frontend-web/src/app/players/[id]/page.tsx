...
export default async function PlayerDetailPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full bg-slate-800 rounded-2xl border border-slate-700 shadow-2xl overflow-hidden relative">
        <Link href="/players" className="absolute top-4 left-4 text-slate-400 hover:text-white z-10 font-bold">← Retour</Link>
        ...
        <div className="flex justify-center -mt-16">
          <div className="w-32 h-32 rounded-full border-4 border-slate-800 overflow-hidden bg-slate-700">
            {player.avatar ? (
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-400 mb-6">{player.race} • {player.class}</p>
