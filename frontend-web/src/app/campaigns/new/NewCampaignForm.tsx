  ...
  return (
    <form action={createCampaignAction} className="space-y-8">
      ...
      <div>
        ...
        <textarea name="synopsis" rows={4} className="w-full theme-input" placeholder="L'histoire en bref..." />
      </div>
      ...
      <div className="pt-6 flex justify-end gap-4 border-t border-[var(--border-main)]">
        <Link href="/campaigns" className="px-4 py-2 text-[var(--text-muted)] hover:text-[var(--text-main)]">Annuler</Link>
        <button type="submit" className="theme-btn-primary">Créer l'Aventure</button>
      </div>
